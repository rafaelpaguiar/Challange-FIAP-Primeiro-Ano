		...
		<div class="row">
			<div class="col grey-bg">
				<span class="grey-title">
					<div class="spacer-10"></div> Cardápio da loja<br>
				</span> Cadastre os itens da sua loja.
				<div class="spacer-10"></div>
				<div class="mb-3 white-form">
					<form class="row g-3" action="cardapio" method="post">
						<div class="col-12">
							<label for="inputAlimento" class="form-label">Alimento</label> <input
								type="text" class="form-control" id="inputAlimento"
								name="inputAlimento">
						</div>
						<div class="col-12">
							<label for="inputTipoAlimento" class="form-label">Tipo de
								Alimento</label> <input type="text" class="form-control"
								id="inputTipoAlimento" name="inputTipoAlimento">
						</div>
						<div class="col-12">
							<label for="inputValorUnitario" class="form-label">Valor
								Unitário (em reais)</label> <input type="text" class="form-control"
								id="inputValorUnitario" name="inputValorUnitario">
						</div>
						<div class="col-12">
							<label for="inputUnidadeMedida" class="form-label">Unidade
								de Medida (em gramas)</label> <input type="text" class="form-control"
								id="inputUnidadeMedida" name="inputUnidadeMedida">
						</div>
						<div class="col-12">
							<input type="hidden" class="form-control" id="inputIdLoja"
								name="inputIdLoja" value="${cnpjLoja}"><br>
						</div>
				</div>
				<div class="row d-flex justify-content-around">
					<div class="col d-flex justify-content-center"><button type="submit" class="btn btn-primary btn-ifood">Cadastrar
						mais</button></form><br></div>
					<div class="col d-flex justify-content-center">
						<button class="btn btn-primary btn-ifood"
							onclick="location.href = 'encerrar.jsp' ">Encerrar</button><br>
					</div>
