		...
		<div class="row">
			<div class="col grey-bg">
				<span class="grey-title">
					<div class="spacer-10"></div> Detalhes da loja<br>
				</span> Preencha abaixo as informações sobre a sua futura loja no iFood com
				os detalhes do seu atendimento.
				<div class="spacer-10"></div>
				<div class="spacer-10"></div>
				<div class="mb-3 white-form">
					<form class="row g-3" action="detalhes" method="post">
						<div class="col-12">
							<label for="inputCategoria" class="form-label">Categoria</label>
							<select class="form-control" id="inputCategoria"
								name="inputCategoria">
								<option value="Campo obrigatório">Campo obrigatório</option>
						...
						<div class="col-12">
							<label for="inputQuantidadeDeFuncs" class="form-label">Quantidade
								de Funcionários</label> <input type="number" class="form-control"
								id="inputQuantidadeDeFuncs" name="inputQuantidadeDeFuncs">
						</div>
						<div class="col-12">
							<label for="inputHoraInicio" class="form-label">Horário
								de Abertura de pedidos</label> <input type="number" class="form-control"
								id="inputHoraInicio" name="inputHoraInicio">
						</div>
						<div class="col-12">
							<label for="inputHoraFim" class="form-label">Horário de
								Encerramento de pedidos</label> <input type="number"
								class="form-control" id="inputHoraFim" name="inputHoraFim">
						</div>
						<div class="col-12">
							<label for="inputTempoEntrega" class="form-label">Tempo
								aproximado da entrega (em minutos)</label> <input type="number" class="form-control"
								id="inputTempoEntrega" name="inputTempoEntrega">
						</div>
						<div class="col-12">
							<label for="inputQuantidadeHora" class="form-label">Média
								aproximada de pedidos por hora</label> <input type="number"
								class="form-control" id="inputQuantidadeHora"
								name="inputQuantidadeHora">
						</div>
						<div class="col-12">
							<label for="inputDiasFuncionamento" class="form-label">Dias
								de funcionamento</label> <select class="form-control"
								id="inputDiasFuncionamento" name="inputDiasFuncionamento">
								<option value="Campo obrigatório">Campo obrigatório</option>
								<option value="Todos os dias">Todos os dias</option>
								<option value="Segunda à Sexta">Segunda à Sexta</option>
								<option value="Segunda à Sábado">Segunda à Sábado</option>
								<option value="Terça à Domingo">Terça à Domingo</option>
								<option value="Quarta e Sábado">Quarta e Sábado</option>
							</select>
						</div>
						<div class="col-12">
							<input type="hidden" class="form-control" id="inputCnpjLoja"
								name="inputCnpjLoja" value="${cnpjLoja}"><br>
						</div>
				</div>
