...
<body>
	<div class="container">
		...
		<div class="row">
                <div class="col">
                    <span class="grey-title"> Muito obrigado!<br>
                    </span>
                <div class="spacer-10"></div>
                <div class="row">
                    <p><strong>Em breve um de nossos consultores entrará em contato.</strong></p>
                    <p><strong>Enquanto aguarda aproveita e pede um Ifood!</strong></p>
                    <div><iframe width="560" height="315" src="https://www.youtube.com/embed/hIUHt7ZpVrk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
	</div>
	</div>
	</div>
